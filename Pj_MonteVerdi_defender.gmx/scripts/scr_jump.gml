...
if(current_y == previous_y) {                  //If on the ground: restarts the timer        
...
if (place_meeting(x, y + vertical_speed, obj_platform_Orpheus) && !place_meeting(x, y, obj_platform_Orpheus) && vertical_speed > 0)  {
